...
import faiss
import numpy as np
from dialogueCorpus import CorpusDatabase
from generativePrompter import Prompter
from langchain.docstore import InMemoryDocstore
from langchain.schema import Document
# from langchain.retrievers import TimeWeightedVectorStoreRetriever
from langchain.vectorstores import FAISS
# from .agentStage import AgentStage
from prompt import *
from time_weighted_retriever import VectorRetriever
from utils import *
...
class GenerativeActor:
    def __init__(
        ...
        self.aggregate_influence = 0
        self.unreflected_documents = []
    ...
    def _init_actor(self):
        ...
        for event in self.profile_events:
            ...
            memory_document = Document(
                ...
                metadata={"event_no": event_no, "created_at": event_datetime, "monologue": event["memory"]}
            )
    ...
    def add_character(self, character: str, alias: List[str]=[], relation: str="Not yet available", impression: str="Not yet available"):
        ...
        while True:
            try:
                ...
                retry_cnt += 1
                print(f"Retry {retry_cnt} add character due to:", e)
                sleep(3)
                if retry_cnt >= 5:
                    break
    ...
    def check_character_occurrence(self, contents: List[str]):
        pass
    ...
    def add_memory(self, memory, force_influence=False, check_reflection=True):
        if isinstance(memory, Document):
            ...
            memory_document.metadata["importance"] = 0
            ...
            memory_document = Document(
                page_content=memory,
                metadata={"importance": 0, "influence": influence, "created_at": memory_time, "monologue": ""}
            )
